...
//      图片加载完毕之后进行压缩，然后上传
       ...
       console.log(imgUrl)
        console.log(imgArr)
          //  imgArr.push(imgUrl);
          //  逻辑代码:存放图片路径的地方
            vm.$store.state.imgUrl.push(imgUrl);


// 			 var $section = $("<section class='up-section fl loading'>");
// 			    //  imgContainer.append($section);//prepend  吉注释了
// 			 var $span = $("<span class='up-span'>");
// 			     $span.appendTo($section);
//            var $img0 =$(document).on('click','.close-upimg',function(event){
// // 吉注释了
//         //   })
// 		    //  var $img0 = $("<img class='close-upimg'>").on("click",function(event){
//            delParent= $(event.target).parent();
//            alert($(event.target).attr('indexs'))
...
//     window.store.state.imgUrl.splice(delArr-1,1)
// 		$(".works-mask").hide();
...
//         });
				...
				// $img0.attr("src","./deleteds.png").appendTo($section);
