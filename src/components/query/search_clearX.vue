  ...
  <div class="margin relative f15 B00 search_clearX" style="width:1220px;" v-if="datas.length!=0">
    ...
    <div class="h500 overflow w100s">
      <div class="lf bai pL20 pR20 pB30 pT30 overflow h440" style="width:740px;">
        ...
        <div class="h300 overflow mB30 relative">
          <!--<img :src="datas.pics[0].url" alt="" class="w100s">-->
              <!--<img :src="datas.pics[0].url.indexOf('?')!=-1?datas.pics[0].url+'|'+image740:datas.pics[0].url+'?'+image740" alt="" class="w100s jz">-->
        </div>
    ...
    <div class="mT10 bai pL20 pR20 block">
      ...
      <ul class="pT20 pB20 overflow">
        <li v-for="(item,index) in datas.pics" class="w287 h400 overflow mB10 tupian relative">
          <!--<img :src="item.url" class="cursor w100s jz preview-img" @click="$preview.open(index,list)" >-->
          <img :src="item.url" class="jz viewerimg" preview='clearXs' style="min-width:100%;min-height:100%;width:100%;">
  ...
  export default {
    data() {
      return {
        ...
        datas: [],
         image740: 'imageView2/1/w/740/h/300',
