<template>
  <div class="margin relative f15 pB30 pT30 B00 bai pL06 pR06 search_clear" style="width:1208px;">
    ...
    <ul class="overflow bai" id="clear">
      <li v-for="(item,index) in datas" class="w560 h210 pL20 pB20 pT20 pR20 border cursor mB06 relative radius10" >
         <div style="border-top-left-radius:10px;border-bottom-right-radius:25px;z-index:2;" class="white center w100 h30 lh30 absolute L00 T00" :class="{bgdbb73f:item.category=='转让',bg4faa90:item.category=='招租'}">{{item.category}}</div>
        <router-link :to="{name:'rentX',params:{objectId:item.objectId}}" target="_blank">
          <!--<div class="w200 h100 overflow radius">-->
            <!--<img :src="item.pics[0].url+imageView2" alt="" class="w100s">-->
